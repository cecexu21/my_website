...
draft: false
image: DJIA_stocks.png # save picture in \static\img\blogs. Acceptable formats= jpg, jpeg, or png . Your iPhone pics wont work
...
```{r plot_1,out.wideth='80%',fig.align='center',cache=TRUE}
myStocks %>%
  group_by(symbol)
ggplot(myStocks,aes(x=date,y=close,fill=symbol,color=symbol))+
  geom_line()+
  labs(title="Closing price for stocks market",x="closing price",y="date")+
  theme(axis.title=element_text(size=2),legend.background = element_blank(),legend.position = "none")
