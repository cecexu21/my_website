...
```{r making_challenge_2_plot, fig.show='hold' ,out.width='40%', fig.align='center',warnings= FALSE, message=FALSE, cache=TRUE}
library(plotly)
...
```{r making_challenge_2_plot_2, fig.show='hold' ,out.width='40%', fig.align='center',warnings= FALSE, message=FALSE, cache=TRUE}
...
```{r making_challenge_2_plot_3, fig.show='hold' ,out.width='40%', fig.align='center',warnings= FALSE, message=FALSE, cache=TRUE}
