...
```{r making_challenge_2_plot_2, fig.show='hold' ,out.width='80%', fig.align='center',warnings= FALSE, message=FALSE, cache=TRUE}
...
```{r making_challenge_2_plot_3, fig.show='hold' ,out.width='80%',,fig.align='center',warnings= FALSE, message=FALSE, cache=TRUE}
