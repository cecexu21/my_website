...
## Reproducing graphs
We will reproduce the following two graphs shown by professor, meanwhile
...
We use mean because it is widely used in statistics world, since it can average all the variables and reduce the nagative effects of extreme numbers, which means outliers in our data. 
