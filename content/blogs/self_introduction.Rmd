...
Through undergraduate and master program, I've learned a lot of statistic knowledge,especially learning a lot of interesting concepts and visualized methods taught by kostis, so this time I will bring some more interesting things to introduce statistics and data visualization.

```{r echo=FALSE, fig.cap="what can r do", out.width = '30%'}
...
Through using some codes, I can mapping the places I was born and I loved!
...
## **<span style="color:grey;">Internship Experience</span>**
...
![ ](/Users/xuchengchen/Desktop/huatai_united.jpg)
