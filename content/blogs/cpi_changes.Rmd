...
Then we will use ifelse function to create a new variable called positive, if yoy(t)>0, then it should be listed as postive, vice versa. Most importantly, we need to figure out whether it is 
